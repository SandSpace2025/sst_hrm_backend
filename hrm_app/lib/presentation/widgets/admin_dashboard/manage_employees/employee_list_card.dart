...
class AnimatedEmployeeListCard extends StatefulWidget {
  ...
  const AnimatedEmployeeListCard({
    super.key,
  ...
  @override
  State<AnimatedEmployeeListCard> createState() =>
      _AnimatedEmployeeListCardState();
}

class _AnimatedEmployeeListCardState extends State<AnimatedEmployeeListCard>
  ...
  Widget _buildCard() {
    final bool isHr = widget.employee.user?.role.toLowerCase() == 'hr';
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildInfoSection(isHr, roleColor),
  ...
  Widget _buildAvatar(Color roleColor) {
  ...
  Widget _buildInfoSection(bool isHr, Color roleColor) {
    return Text(
  ...
  Widget _buildActionsSection(bool isHr, Color roleColor) {
    ...
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        _buildActionButton(Icons.person_rounded, 'Profile', () {
          _triggerHaptic();
          widget.onViewProfile();
        }, roleColor),
      ],
