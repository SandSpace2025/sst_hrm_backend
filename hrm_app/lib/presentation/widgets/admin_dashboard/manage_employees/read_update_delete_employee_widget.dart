...
class EmployeeManagementScreen extends StatefulWidget {
  ...
  const EmployeeManagementScreen({super.key, required this.employee});
...
class _EmployeeManagementScreenState extends State<EmployeeManagementScreen>
  ...
  void _updateJobTitleDropdown() {
    ...
    final titles =
        ...
        jobRoles[defaultOrgKey]?[_selectedJobCategory] ??
        [];
    setState(() {
  ...
  Future<void> _handleSaveChanges() async {
    ...
    try {
      await adminProvider.updateUser(
        userId: widget.employee.user!.id,
        data: updateData,
        token: token,
      );
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading =
        adminProvider.isUpdatingUser || adminProvider.isDeletingUser;
