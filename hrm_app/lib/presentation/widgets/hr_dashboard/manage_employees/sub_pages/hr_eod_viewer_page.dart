...
class HREodViewerPage extends StatefulWidget {
  final Employee employee;
  const HREodViewerPage({super.key, required this.employee});

  @override
  State<HREodViewerPage> createState() => _HREodViewerPageState();
}

class _HREodViewerPageState extends State<HREodViewerPage>
  ...
  Widget _buildLoadingState() {
    return const Center(
      child: Column(
        ...
        children: [
          CircularProgressIndicator(color: AppColors.edgePrimary),
          SizedBox(height: 16),
          Text(
            'Loading EOD reports...',
            style: TextStyle(
