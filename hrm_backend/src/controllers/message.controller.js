...
const sendMessageToEmployee = async (req, res) => {
  try {
    ...
    logger.error("Error sending message to employee", { error: error.message });
    res.status(500).json({
...
const sendMessageToHR = async (req, res) => {
  try {
    ...
    logger.error("Error sending message to HR", { error: error.message });
...
const getAdminMessages = async (req, res) => {
  try {
    ...
    const query = {
      $or: [
        { "sender.userId": admin._id, "sender.userType": "Admin" },
...
const archiveMessage = async (req, res) => {
  try {
    ...
    logger.error("Error archiving message", { error: error.message });
    res.status(500).json({ message: "Internal server error" });
  }
};
...
const getEmployeesForMessaging = async (req, res) => {
  try {
    ...
    logger.error("Error fetching employees for messaging", {
      error: error.message,
    });
    res.status(500).json({ message: "Internal server error" });
  }
...
const getHRForMessaging = async (req, res) => {
  try {
    ...
    logger.error("Error fetching HR for messaging", { error: error.message });
    res.status(500).json({ message: "Internal server error" });
  }
};
...
const approveEmployeeMessages = async (req, res) => {
  try {
    ...
    logger.error("Error approving employee messages", { error: error.message });
    res.status(500).json({ message: "Internal server error" });
  }
};
...
const getAdminConversationSimple = async (req, res) => {
  try {
    ...
    logger.error("Error getting admin conversation", { error: err.message });
