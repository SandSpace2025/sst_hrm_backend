...
exports.requestMessagingPermission = async (req, res) => {
  try {
    ...
    console.error("Error requesting messaging permission:", err);
    res.status(500).json({ message: err.message });
  }
};
...
exports.grantMessagingPermission = async (req, res) => {
  try {
    ...
    console.error("Error granting messaging permission:", err);
    res.status(500).json({ message: err.message });
  }
};
...
exports.revokeMessagingPermission = async (req, res) => {
  try {
    ...
    console.error("Error revoking messaging permission:", err);
    res.status(500).json({ message: err.message });
  }
};
...
exports.getMessagingPermissionRequests = async (req, res) => {
  try {
    ...
    console.error("Error getting messaging permission requests:", err);
    res.status(500).json({ message: err.message });
  }
};
...
exports.getActiveMessagingPermissions = async (req, res) => {
  try {
    ...
    console.error("Error getting active messaging permissions:", err);
    res.status(500).json({ message: err.message });
  }
};
